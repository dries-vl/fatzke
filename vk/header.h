...
enum KEYBOARD_BUTTON {
    KEYBOARD_BUTTON_UNKNOWN = 0, KEYBOARD_ESCAPE,
    KEYBOARD_ENTER, KEYBOARD_BACKSPACE, KEYBOARD_TAB, KEYBOARD_SPACE, KEYBOARD_LEFT, KEYBOARD_RIGHT, KEYBOARD_UP, KEYBOARD_DOWN,
